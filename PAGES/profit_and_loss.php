...
// Fetch total revenue (from sales and sales_items) for the current year or filtered date range
...
$total_revenue = $rev_row['total_revenue'] ?? 45850.00; // Fallback mock/real
$total_transactions = $rev_row['total_transactions'] ?? 120;

// Fetch total approved budget requests (Restock / Refill operational costs)
    ...
    <div class="flex h-screen w-full overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <main class="p-6 space-y-6">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
                    <form method="GET" class="flex flex-wrap items-end gap-4">
                        <div>
                            ...
                            <input type="date" name="start_date" value="<?php echo date('Y-01-01'); ?>" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-orange-500">
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-gray-600 mb-1">End Date</label>
                            <input type="date" name="end_date" value="<?php echo date('Y-m-d'); ?>" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-orange-500">
                        </div>
                        <div>
                            <button type="submit" class="bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors flex items-center gap-2 shadow-sm cursor-pointer">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    <div class="flex justify-between items-center mb-4">
                        <h5 class="text-sm font-bold text-gray-800 flex items-center gap-2">
                            <i class="bi bi-bar-chart-fill text-orange-500"></i> Revenue vs Expenses Trend Analysis
                        </h5>
                ...
                <!-- Financial Statement Breakdown Table & Budget List Integration -->
